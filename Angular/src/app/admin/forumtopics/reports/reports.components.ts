...
import { filteroptions } from "../../../reducers/forumtopics/selectors";
...
export class ForumTopicsReportsComponent implements OnInit {
  constructor(
  ...
  FilterOptions: any = {};
  showLoader = false;
  formHeading = "Forum Topic Reports";
  isAdmin = true;
