...
export class FormService {
  getControls(entity: any, prop: string, child_prop: string, iswizard = false) {
    switch (prop) {
      ...
      case "forums":
        switch (child_prop) {
          case "general":
            return this.prepareForumsGeneralControls(entity);
          default:
            return [];
        }
        break;
  ...
  prepareMediaSettingControls(entity: any, iswizard: boolean) {
    ...
    /* controls.push(
      new Controls.Textbox({
        ...
        value: entity.gamify_badge_width.toString(),
        colsize: "col-md-12",
        pattern: "[0-9]+",
        required: true,
        helpblock:
    ...
    controls.push(
      new Controls.Textbox({
        ...
        value: entity.gamify_badge_height.toString(),
        colsize: "col-md-12",
        pattern: "[0-9]+",
        required: true,
        helpblock:
  ...
  prepareFeatureSettingControls(entity: any, iswizard: boolean) {
    ...
    controls.push(
      new Controls.CheckBox({
        key: "enable_forums",
        label: "Enable Forums",
        value: entity.enable_forums,
        checked: entity.enable_forums,
        helpblock:
  ...
  prepareForumsGeneralControls(entity: any) {
    const controls: FormBase<any>[] = [];

    controls.push(
      new Controls.CheckBox({
        key: "enable_public_topics",
        label: "Enable Public Topics",
        value: entity.enable_public_topics,
        checked: entity.enable_public_topics,
        helpblock:
