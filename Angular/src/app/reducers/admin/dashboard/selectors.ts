...
export const topics = (state: IAppState) => state.dashboard.topics;
export const blogs = (state: IAppState) => state.dashboard.blogs;
export const users = (state: IAppState) => state.dashboard.users;
export const topic_report = (state: IAppState) => state.dashboard.topic_report;
...
export const topic_loading = (state: IAppState) => state.dashboard.topic_loading;
...
export const topic_report_loading = (state: IAppState) => state.dashboard.topic_report_loading;
...
export const topic_error = (state: IAppState) => state.dashboard.topic_error;
...
export const topic_report_error = (state: IAppState) => state.dashboard.topic_report_error;
...
export const is_topic_report_loaded = (state: IAppState) => state.dashboard.is_topic_report_loaded;
