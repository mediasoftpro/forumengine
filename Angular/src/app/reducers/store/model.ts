...
import { IForumState, FORUM_INITIAL_STATE } from "../forums/model";
import { IForumTopicState, FORUM_TOPICS_INITIAL_STATE } from "../forumtopics/model";
...
export const initializeAppState: IAppState = {
    ...
    forums: FORUM_INITIAL_STATE,
    blogs: BLOG_INITIAL_STATE,
    forumtopics: FORUM_TOPICS_INITIAL_STATE,
