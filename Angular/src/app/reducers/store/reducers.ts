...
import { createForumsReducer } from "../forums/reducer";
import { createForumTopicsReducer } from "../forumtopics/reducer";
...
export const rootReducer = composeReducers(
  ...
  combineReducers({
    ...
    forums: createForumsReducer(),
    forumtopics: createForumTopicsReducer(),
