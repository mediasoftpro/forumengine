...
export const appRoutes: Routes = [
  ...
  {
    path: "forumtopics",
    loadChildren: () => import('./admin/forumtopics/forums.module').then(m => m.ForumTopicsModule)
    //canActivate: [JMediaLazyGuard],
  ...
  {
    path: "my-topics",
    loadChildren: () => import('./account/forumtopics/forums.module').then(m => m.ForumTopicsModule)
