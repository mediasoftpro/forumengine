...
namespace ForumEngine.Areas.api.Controllers
{
    ...
    public class configurationController : ControllerBase
    {
        ...
        Jugnoon.Forums.Settings.General _forums_general_Settings;
        ...
        public configurationController(
            ...
            IOptions<Jugnoon.Forums.Settings.General> forums_general_Settings
         )
        {
            // writable injectors
            ...
            _forums_general_Settings = forums_general_Settings.Value;
        }
        ...
        public ActionResult load()
        {
            return Ok(new
            {
                configurations = new
                {
                    ...
                    forums = new
                    {
                        general = _forums_general_Settings
                    }
