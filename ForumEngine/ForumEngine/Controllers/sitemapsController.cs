...
namespace ForumEngine.Controllers
{
    public class sitemapsController : Controller
    {
        ...
        public async Task<IActionResult> forums(string rt = null)
        {
            ...
            {
                case 0:
                    sXml = await ForumFeeds.BuildGoogleSiteMap(_context, 1, 50000);
                    break;
                case 1:
        ...
        public async Task<IActionResult> forumtopics(string rt = null)
        {
            string sXml = "";
            int responsetype = 0; // 0: google, 1: bing
            if (rt != null)
            ...
            {
                case 0:
                    sXml = await ForumTopicFeeds.BuildGoogleSiteMap(_context, 1, 50000);
                    break;
                case 1:
                    sXml = await ForumTopicFeeds.BuildYahooSiteMap(_context, 1, 50000);
                    break;
            }
