...
namespace Jugnoon.Framework
{
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser, ApplicationRole, string>
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            // JGN_Forums
            builder.Entity<JGN_Forums>().Property(b => b.threads).HasDefaultValue(0);
            builder.Entity<JGN_Forums>().Property(b => b.posts).HasDefaultValue(0);
            //builder.Entity<JGN_Forums>().Property(b => b.lastpostid).HasDefaultValue(0);
            builder.Entity<JGN_Forums>().Property(b => b.isenabled).HasDefaultValue(0);
            builder.Entity<JGN_Forums>().Property(b => b.priority).HasDefaultValue(0);

            // JGN_ForumTopics
            builder.Entity<JGN_ForumTopics>().Property(b => b.forumid).HasDefaultValue(0);
            builder.Entity<JGN_ForumTopics>().Property(b => b.views).HasDefaultValue(0);
            builder.Entity<JGN_ForumTopics>().Property(b => b.replies).HasDefaultValue(0);
            builder.Entity<JGN_ForumTopics>().Property(b => b.isenabled).HasDefaultValue(0);
            builder.Entity<JGN_ForumTopics>().Property(b => b.isapproved).HasDefaultValue(0);
            builder.Entity<JGN_ForumTopics>().Property(b => b.isadult).HasDefaultValue(0);
            builder.Entity<JGN_ForumTopics>().Property(b => b.liked).HasDefaultValue(0);
            builder.Entity<JGN_ForumTopics>().Property(b => b.disliked).HasDefaultValue(0);
            builder.Entity<JGN_ForumTopics>().Property(b => b.replyid).HasDefaultValue(0);
            builder.Entity<JGN_ForumTopics>().Property(b => b.isresolved).HasDefaultValue(0);
            builder.Entity<JGN_ForumTopics>().Property(b => b.type).HasDefaultValue(0);
            builder.Entity<JGN_ForumTopics>().Property(b => b.islocked).HasDefaultValue(0);
            builder.Entity<JGN_ForumTopics>().Property(b => b.resolvedpostid).HasDefaultValue(0);
            builder.Entity<JGN_ForumTopics>().Property(b => b.contentid).HasDefaultValue(0);
            builder.Entity<JGN_ForumTopics>().Property(b => b.contenttype).HasDefaultValue(0);
            // JGN_Languages
        ...
        public virtual DbSet<JGN_ForumTopics> JGN_ForumTopics { get; set; }
        public virtual DbSet<JGN_Forums> JGN_Forums { get; set; }
