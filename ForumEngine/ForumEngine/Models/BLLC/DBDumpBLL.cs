    ...
    public class DBDumpBLL
    {
        ...
        public static async Task InitializeMailTemplates(ApplicationDbContext context)
        {
            if (await MailTemplateBLL.Count(context, new MailTemplateEntity() { type = "-1" }) == 0)
            {
                ...
                if (Settings.Configs.FeatureSettings.enable_forums)
                {
                    MailTemplates.Add(new JGN_MailTemplates
                    {
                        templatekey = "FORUMTOPIC",
                        description = "Forum - Admin Notification (New Topic Posted)",
                        type = "forum",
                        subjecttags = "[username],[subject]",
                        tags = "[username],[subject],[content],[url]",
                        subject = "New topic posted on [website]",
                        contents = "<p>Hello,<br /><br />[username] posted new forum topic on <a href='[website_url]' title='[website]'>[website]</a>.</p>" +
                    ...
                    {
                        templatekey = "FORUMTA",
                        description = "Forum - Author Notification (New Post)",
                        type = "forum",
                        subjecttags = "[username],[subject]",
                        tags = "[username],[subject],[content],[url]",
                        subject = "Your topic posted on [website]",
                        contents = "<p>Hello,<br /><br />your topic has been posted successfully and is waiting for review on <a href='[website_url]' title='[website]'>[website]</a>.</p>" +
                        "<p><a title='[subject]' href='[url]'>[subject]</a></p>" +
                        "<p>[content]</p>" +
                        return_template_signature()
                    });
                    ...
                    MailTemplates.Add(new JGN_MailTemplates
                    {
                        templatekey = "FORUMTREP",
                        description = "Forum - Reply Notifications",
                        type = "forum",
                        subjecttags = "[poster_username],[username],[subject]",
                        tags = "[poster_username],[username],[subject],[content],[url]",
                        subject = "[poster_username] replied on your topic on [website]",
                        contents = "<p>Hello,<br /><br />[poster_username] post a new reply to your topic on <a href='[website_url]' title='[website]'>[website]</a>.</p>" +
                        "<p><a title='[subject]' href='[url]'>[subject]</a></p>" +
                        "<p>[content]</p>" +
                        return_template_signature()
                    });
